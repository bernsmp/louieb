...
date: '2026-01-20'
image: >-
  https://apkwktwnjvspfinrnhmz.supabase.co/storage/v1/object/public/media/articles/1774029375635_vp-sales-post-mortem-header.png
category: Hiring
---
...
* Seven warning signs appear within the first 90 days that predict failure with 90% accuracy.

* A Fractional Sales Leader can either rescue the situation by building the missing infrastructure or replace the VP cost-effectively.
...
1. Incompetence: The VP does not understand the product, the market, or the sales process
2. Inauthenticity: The VP talks a big game but does not follow through
...
1. They do not know how to build one (they have only worked at companies where it already existed), or
2. They do not think it is important (they believe sales is only an art, and not a science, as well)
