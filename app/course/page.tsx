    ...
    <main className="bg-white">
      ...
      <section className="bg-neutral-50 py-32">
        <div className="container mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {/* CTA to Full Course */}
          <div className="mt-16 rounded-3xl border-2 border-neutral-900 bg-neutral-900 p-12 text-center text-white">
            <h3 className="text-4xl font-bold md:text-5xl">
              Ready to Complete the Full System?
            </h3>
            ...
            <a
              ...
              className="mt-8 inline-block rounded-lg bg-white px-10 py-4 text-lg font-semibold text-neutral-900 transition-all hover:bg-neutral-100 hover:shadow-xl"
            >
              Watch Complete Course on YouTube →
            </a>
          </div>
        </div>
      </section>
