...
const revopsDefinition = [
  {
    number: '01',
    title: 'Revenue Operations Is Not a Department',
    body: 'RevOps is a function — a set of processes, tools, and accountability structures that align your sales, marketing, and customer success teams around a shared revenue goal. In most $1M–$10M companies, one person (or a fractional leader) handles the RevOps function as part of the broader sales leadership role.',
  },
  {
    number: '02',
    title: 'Its Job Is Eliminating Revenue Friction',
    body: 'Revenue friction is anything that slows down or stops deals from closing: a CRM that\'s not configured correctly, handoffs between marketing and sales that lose leads, pricing processes that create unnecessary delays, or a customer success team that doesn\'t flag expansion opportunities. RevOps finds and fixes these friction points systematically.',
  },
  {
    number: '03',
    title: 'It Owns the Systems, Not the Selling',
    body: 'RevOps doesn\'t close deals. It builds and maintains the infrastructure that enables deals to close: the CRM configuration, the reporting dashboards, the lead routing rules, the contract workflows, and the onboarding handoffs. Think of it as the operations layer under your entire revenue-generating function.',
  },
  {
    number: '04',
    title: 'It Creates Revenue Predictability',
    body: 'The defining outcome of good RevOps is a revenue number you can forecast with confidence. When the data is clean, the pipeline stages are real, and the handoffs are smooth, the forecast becomes reliable. Investors, boards, and founders all need this. Most companies under $10M ARR don\'t have it — because they haven\'t built the RevOps infrastructure to produce it.',
  },
]
...
const comparison = [
  {
    ...
    sales: 'Close deals',
    revops: 'Enable deals to close more efficiently',
    fractional: 'Build and manage the sales team',
  },
  {
    label: 'Owns the CRM',
    sales: 'Uses the CRM',
    revops: 'Configures and maintains the CRM',
    fractional: 'Sets CRM strategy and requirements',
  },
  {
    label: 'Focus on revenue',
    sales: 'Current quarter pipeline',
    revops: 'Systems that improve long-term conversion',
    fractional: 'Team performance and quarterly attainment',
  },
  {
    label: 'Works with',
    sales: 'Prospects and customers',
    revops: 'Sales, marketing, and CS teams',
    fractional: 'Sales reps, founders, and RevOps function',
  },
  {
    label: 'Typical hire stage',
    sales: 'First $500K ARR',
    revops: '$5M–$10M ARR or earlier with fractional',
    fractional: '$1M–$10M ARR',
  },
]

const needsRevops = [
  { signal: 'Your CRM data is incomplete or not trusted for forecasting', needs: true },
  { signal: 'Marketing generates leads that sales never follows up on', needs: true },
  { signal: 'You can\'t tell which marketing campaigns are producing pipeline', needs: true },
  { signal: 'Contract and proposal processes create unnecessary delays', needs: true },
  { signal: 'Customer success doesn\'t know which accounts are at risk', needs: true },
  { signal: 'You have clean pipeline data and a reliable forecast', needs: false },
]
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg leading-relaxed text-neutral-700">
              ...
              isn't reliable, RevOps infrastructure is almost always the root cause.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          >
            <motion.h2
              ...
              className="mb-4 text-center font-serif text-3xl font-bold text-neutral-900 md:text-4xl"
            >
              RevOps vs. Sales Ops vs. Fractional Sales Leader
            </motion.h2>
            <motion.p variants={itemVariants} className="mb-10 text-center text-neutral-600">
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          >
            <motion.h2
              ...
              className="mb-4 text-center font-serif text-3xl font-bold text-neutral-900 md:text-4xl"
            >
              Does Your Company Need RevOps Right Now?
            </motion.h2>
