...
import { getFSLPageData } from "@/lib/cms";
...
function generateVideoListSchema(videos: Array<{ videoId: string; title: string; description?: string }>) {
...
export default async function FractionalSalesLeaderPage() {
  ...
  const pageData = await getFSLPageData();
          ...
          <div className="container mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
              {pageData.videos.map((video, index) => (
                ...
                >
                  {/* Video Embed - Shorts 9:16 aspect ratio */}
