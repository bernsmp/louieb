...
const frameworkStructure = [
  {
    label: "The Story",
    desc: "What happened. The real version, with the details that made it hard.",
  },
  {
    label: "The Decision",
    desc: "What this moment was really about and why founders and entrepreneurs get it wrong.",
  },
  {
    label: "The Resilience Connection",
    desc: "How surviving this decision builds a specific layer of resilience you will need for every stage after it.",
  },
  {
    label: "The Lesson",
    desc: "What to do when you hit this moment yourself.",
  },
  {
    label: "The Claude Prompts",
    desc: "Coaching, advisory, and mindset prompts to apply the framework to your situation today.",
  },
];
...
const whatIsIncluded = [
  ...
  "Before You Leave The Dock™ — free companion guide included",
        ...
        <BackgroundCells className="bg-slate-950">
          <div className="px-6 pb-20 pt-8 text-center">
            ...
            <p className="mt-4 text-sm text-neutral-600">
              $47 · One-time · Instant PDF download · Includes free companion
              guide
            </p>
          </div>
        </BackgroundCells>
        ...
        <div className="container mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <div className="mx-auto mt-12 max-w-3xl rounded-2xl border-l-4 border-neutral-900 bg-neutral-50 p-8 text-left">
            <p className="text-xl font-semibold leading-relaxed text-neutral-900 md:text-2xl">
              Louie Bernstein survived all five. Here&apos;s the honest version.
            </p>
            <p className="mt-6 text-lg text-neutral-600">
              Not the highlights reel. The real story — with the numbers, the
              mistakes, the months where he didn&apos;t know if it would work
              out. And exactly what each one built in him that the next stage
              required.
            </p>
            <div className="mt-6 rounded-xl bg-neutral-900 px-6 py-4">
              <p className="text-base font-semibold text-white">
                ...
                decade — by the founders and entrepreneurs who choose to stay in
                the game.&rdquo;
              </p>
        ...
        <div className="container mx-auto max-w-6xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-xl text-neutral-600">
              If you go through all five decisions — read the stories, work the
              prompts, apply the framework — here is what changes.
            </p>
          </div>
      ...
      <section className="bg-neutral-50 py-24">
        <div className="container mx-auto max-w-5xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-xl text-neutral-600">
              Each of the five decisions follows the same format. Every chapter
              is a complete decision toolkit.
            </p>
          </div>
          ...
          <p className="mx-auto mt-8 max-w-2xl text-center text-lg font-semibold text-neutral-700">
            The Resilience Connection is what separates this from every other
            business book. It shows exactly how each decision builds a layer of
            resilience you will need at every stage after it.
          </p>
        </div>
      </section>
      ...
      <section id="whats-inside" className="bg-white py-24">
        <div className="container mx-auto max-w-6xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-xl text-neutral-600">
              One per decade. The real story. What it cost. What it built. And
              exactly how it made the next stage possible.
            </p>
          </div>
        ...
        <div className="container relative z-10 mx-auto max-w-6xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-xl text-neutral-400">
              Not generic reflection questions. A resilience framework built
              from Louie&apos;s actual thinking — engineered so you run{" "}
          ...
          <div className="mt-12 rounded-2xl border border-neutral-700 bg-neutral-800/30 p-8 text-center">
            <p className="text-lg font-semibold text-neutral-300 md:text-xl">
              &ldquo;Thirty minutes with these prompts is the closest thing to
              sitting across from someone who has been exactly where you are
        ...
        <div className="container mx-auto max-w-5xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-lg text-neutral-600">
              People everywhere are looking for someone who went through the
              hard part and made it. That is who you can be. But you have to
              build toward it.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-neutral-200 bg-white p-10 text-center shadow-sm">
              ...
              <div className="mt-6 text-6xl font-bold text-neutral-900">
                12M
              </div>
              <div className="mt-2 text-lg font-semibold text-neutral-600">
                Impressions on Reddit
              </div>
              <div className="mt-1 text-base text-neutral-500">
                110,000 upvotes on &ldquo;Things I&apos;ve learned in 72
                years&rdquo;
              </div>
            </div>
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-neutral-200 bg-white p-10 text-center shadow-sm">
              ...
              <div className="mt-1 text-base text-neutral-500">
                A country being bombed daily — still showing up to build
                resilience. The need for this framework is everywhere.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-24">
        <div className="container mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-xl leading-relaxed text-neutral-600">
            Still deciding whether to start? The free companion guide helps
            aspiring entrepreneurs answer five critical questions before the
            cost is real. Get it free — then come back when you&apos;re ready
            for what comes next.
          </p>
          <div className="mt-8">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block rounded-lg border-2 border-neutral-900 bg-white px-10 py-4 text-base font-bold text-neutral-900 transition-all hover:bg-neutral-900 hover:text-white"
            >
