...
export default function SeoWhenToHireCroPage() {
  return (
    <SectionEditor
      section="seoWhenToHireCro"
      title="SEO: When to Hire a CRO"
      description="Edit content for /when-to-hire-a-cro"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'When to Hire' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'a CRO' },
