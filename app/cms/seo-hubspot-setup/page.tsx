...
export default function SeoHubSpotSetupPage() {
  return (
    <SectionEditor
      section="seoHubSpotSmallSalesTeam"
      title="SEO: How to Set Up HubSpot for a Small Sales Team"
      description="Edit content for /how-to-set-up-hubspot-for-small-sales-team"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/how-to-set-up-hubspot-for-small-sales-team"
    />
  )
}
