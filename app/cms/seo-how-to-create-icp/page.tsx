...
export default function SeoHowToCreateICPPage() {
  return (
    <SectionEditor
      section="seoHowToCreateICP"
      title="SEO: How to Create an Ideal Customer Profile"
      description="Edit content for /how-to-create-an-ideal-customer-profile"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Create an Ideal Customer Profile' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'for a B2B Sales Team' },
