...
export default function SeoFractionalLeaderPartTimePage() {
  return (
    <SectionEditor
      section="seoFractionalLeaderPartTime"
      title="SEO: Fractional Leader Leading Team Part-Time"
      description="Edit content for /can-fractional-sales-leader-lead-team-part-time"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        // Hero
        ...
        { name: 'seoPara2', label: 'SEO Paragraph 2 (text before first link)', type: 'textarea', aiRewrite: true, rows: 4 },
        ...
        // Sequence (3 phases)
        { name: 'sectionSequenceHeading', label: 'Sequence: Section Heading', type: 'text', aiRewrite: true },
        { name: 'sectionSequenceSubheading', label: 'Sequence: Section Subheading', type: 'textarea', rows: 2 },
      ...
      previewUrl="/can-fractional-sales-leader-lead-team-part-time"
    />
  )
}
