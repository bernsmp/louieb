...
export default function SeoOnboardSalesRepPage() {
  return (
    <SectionEditor
      section="seoOnboardNewSalesRep"
      title="SEO: How to Onboard a New Sales Rep"
      description="Edit content for /how-to-onboard-new-sales-rep"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/how-to-onboard-new-sales-rep"
    />
  )
}
