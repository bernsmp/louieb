...
export default function SeoCroCostPage() {
  return (
    <SectionEditor
      section="seoCroCost"
      title="SEO: How Much Does a Fractional CRO Cost?"
      description="Edit content for /how-much-does-a-fractional-cro-cost"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How Much Does a' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Fractional CRO Cost?' },
