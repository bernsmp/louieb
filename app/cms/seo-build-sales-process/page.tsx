...
export default function SeoBuildSalesProcessPage() {
  return (
    <SectionEditor
      section="seoBuildSalesProcess"
      title="SEO: How to Build a Sales Process After $1M ARR"
      description="Edit content for /how-to-build-a-sales-process-after-1m-arr"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Build a Sales Process' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'After $1M ARR' },
