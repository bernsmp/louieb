...
export default function SeoSalesForecastingInvestorsPage() {
  return (
    <SectionEditor
      section="seoSalesForecastingInvestors"
      title="SEO: How to Create a Sales Forecast Your Investors Will Actually Believe"
      description="Edit content for /sales-forecasting-for-investors"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Create a Sales Forecast' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Your Investors Will Actually Believe' },
