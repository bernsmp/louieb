...
export default function SeoFractionalCROPage() {
  return (
    <SectionEditor
      section="seoFractionalCRO"
      title="SEO: Fractional CRO for $1M–$10M Founders"
      description="Edit content for /fractional-cro-for-1m-10m-founders"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'You Built a $1M Business' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Closing Every Deal Yourself.' },
        { name: 'heroLine3', label: 'Hero: Line 3 (optional)', type: 'text', placeholder: "That's the Problem." },
