...
export default function SeoWhatFslDoesPage() {
  return (
    <SectionEditor
      section="seoWhatFslDoes"
      title="SEO: What Does a Fractional Sales Leader Do Week to Week?"
      description="Edit content for /what-does-fractional-sales-leader-do"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/what-does-fractional-sales-leader-do"
    />
  )
}
