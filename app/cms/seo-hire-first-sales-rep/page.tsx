...
export default function SeoHireFirstSalesRepPage() {
  return (
    <SectionEditor
      section="seoHireFirstSalesRep"
      title="SEO: How to Hire Your First Sales Rep"
      description="Edit content for /how-to-hire-first-sales-rep"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Hire Your' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'First Sales Rep' },
