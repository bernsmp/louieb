...
export default function SeoHireOneOrTwoSalespersonPage() {
  return (
    <SectionEditor
      section="seoHireOneOrTwoSalespeople"
      title="SEO: Hire One or Two Salespeople?"
      description="Edit content for /hire-one-salesperson-or-two"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/hire-one-salesperson-or-two"
    />
  )
}
