...
export default function SeoSalesCompPlanPage() {
  return (
    <SectionEditor
      section="seoSalesCompensationPlan"
      title="SEO: How to Build a Sales Compensation Plan"
      description="Edit content for /how-to-build-sales-compensation-plan"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/how-to-build-sales-compensation-plan"
    />
  )
}
