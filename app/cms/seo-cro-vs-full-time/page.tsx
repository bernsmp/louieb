...
export default function SeoCroVsFullTimePage() {
  return (
    <SectionEditor
      section="seoCroVsFullTime"
      title="SEO: Fractional CRO vs. Full-Time CRO"
      description="Edit content for /fractional-cro-vs-full-time-cro"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'Fractional CRO vs.' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Full-Time CRO' },
