...
export default function SeoSalesTeamNotHittingQuotaPage() {
  return (
    <SectionEditor
      section="seoSalesTeamNotHittingQuota"
      title="SEO: Sales Team Not Hitting Quota"
      description="Edit content for /sales-team-not-hitting-quota"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: "Your Sales Team Isn't Hitting Quota." },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: "Here's How to Diagnose It." },
