...
export default function SeoOutboundSalesSystemPage() {
  return (
    <SectionEditor
      section="seoBuildOutboundSalesSystem"
      title="SEO: How to Build an Outbound Sales System"
      description="Edit content for /how-to-build-outbound-sales-system"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/how-to-build-outbound-sales-system"
    />
  )
}
