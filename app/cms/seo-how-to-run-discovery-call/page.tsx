...
export default function SeoHowToRunDiscoveryCallPage() {
  return (
    <SectionEditor
      section="seoHowToRunDiscoveryCall"
      title="SEO: How to Run a Sales Discovery Call"
      description="Edit content for /how-to-run-a-discovery-call"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Run a Sales Discovery Call' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'That Actually Moves Deals Forward' },
