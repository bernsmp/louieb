...
export default function SeoWhatIsFounderLedSalesPage() {
  return (
    <SectionEditor
      section="seoWhatIsFounderLedSales"
      title="SEO: What Is Founder-Led Sales"
      description="Edit content for /what-is-founder-led-sales"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/what-is-founder-led-sales"
    />
  )
}
