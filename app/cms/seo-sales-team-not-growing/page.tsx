...
export default function SeoSalesTeamNotGrowingPage() {
  return (
    <SectionEditor
      section="seoSalesTeamNotGrowingRevenue"
      title="SEO: Why Sales Team Not Growing Revenue"
      description="Edit content for /why-sales-team-not-growing-revenue"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/why-sales-team-not-growing-revenue"
    />
  )
}
