...
export default function SeoReplaceFounderSalesPage() {
  return (
    <SectionEditor
      section="seoReplaceFounderSales"
      title="SEO: How to Replace Founder-Led Sales"
      description="Edit content for /how-to-replace-founder-led-sales"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Replace Founder-Led Sales' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Without Losing Momentum' },
