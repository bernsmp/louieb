...
export default function SeoSalesTechStackPage() {
  return (
    <SectionEditor
      section="seoSalesTechStackSmallBusiness"
      title="SEO: What Is a Sales Tech Stack?"
      description="Edit content for /sales-tech-stack-for-small-business"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'What Is a Sales Tech Stack?' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'The Minimum Setup for a $1M–$10M Business' },
