...
export default function SeoSalesForecastingPage() {
  return (
    <SectionEditor
      section="seoSalesForecastingSmallBusiness"
      title="SEO: Sales Forecasting for Small Business"
      description="Edit content for /sales-forecasting-for-small-business"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/sales-forecasting-for-small-business"
    />
  )
}
