...
export default function SeoSetSalesQuotaPage() {
  return (
    <SectionEditor
      section="seoHowToSetSalesQuota"
      title="SEO: How to Set Quota for a Small Sales Team"
      description="Edit content for /how-to-set-sales-quota"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Set Quota for a Small Sales Team' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'When You Have No Benchmarks' },
