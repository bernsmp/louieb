    ...
    try {
      ...
      if (data.service) {
        setForm({
          ...
          highlight: data.service.highlight || false,
          display_order: data.service.display_order || 0,
        })
      }
    } catch (error) {
    ...
    <div className="edit-page">
      <div className="edit-page__header">
        <div>
          ...
          <h1 className="edit-page__title">Edit Service</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="edit-form">
        ...
        <div className="edit-form__row">
          <div className="form-group">
            ...
            <input type="text" className="form-input" value={form.icon} onChange={(e) => setForm({ ...form, icon: e.target.value })} />
          </div>
          <div className="form-group">
