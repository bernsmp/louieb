...
export default function SeoCostFractionalVpPage() {
  return (
    <SectionEditor
      section="seoCostFractionalVp"
      title="SEO: Cost of Fractional VP of Sales"
      description="Edit content for /cost-of-fractional-vp-sales"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/cost-of-fractional-vp-sales"
    />
  )
}
