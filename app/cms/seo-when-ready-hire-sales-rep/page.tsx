...
export default function SeoWhenReadyHireSalesRepPage() {
  return (
    <SectionEditor
      section="seoWhenReadyHireFirstSalesRep"
      title="SEO: When Ready to Hire First Sales Rep"
      description="Edit content for /when-ready-hire-first-sales-rep"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/when-ready-hire-first-sales-rep"
    />
  )
}
