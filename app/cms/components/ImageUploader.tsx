...
interface ImageUploaderProps {
  ...
  showAltTextButton?: boolean  // Show AI alt text button
  onAltTextGenerated?: (altText: string) => void  // Callback when alt text is generated
}
...
export function ImageUploader({
  ...
  const [suggestedAltText, setSuggestedAltText] = useState<string>('')
  const [showAltTextField, setShowAltTextField] = useState(false)
  ...
  const handleAltTextChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSuggestedAltText(newValue)
    if (onAltTextGenerated) {
      onAltTextGenerated(newValue)
    }
  }
    ...
    <div className="image-uploader">
      ...
      {value ? (
        ...
        <div className="image-uploader__preview-wrapper">
          ...
          {showAltTextButton && (
            <div className="image-uploader__alt-text-section">
              <button
                type="button"
                onClick={handleGenerateAltText}
                disabled={isGeneratingAltText}
                className="image-uploader__ai-btn"
              >
                <span className="image-uploader__ai-icon">✨</span>
                {isGeneratingAltText ? 'Generating...' : 'Suggest alt text'}
              </button>

              {showAltTextField && (
                <div className="image-uploader__alt-text-field">
                  <label className="image-uploader__alt-text-label">
                    Alt text suggestion:
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="Edit suggested alt text..."
                    className="image-uploader__alt-text-input"
                  />
                </div>
              )}
            </div>
