...
export default function SeoSalesCompPlanDesignPage() {
  return (
    <SectionEditor
      section="seoSalesCompPlanDesign"
      title="SEO: How Do I Design a Good Sales Comp Plan?"
      description="Edit content for /how-do-i-design-a-good-sales-comp-plan"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        // Hero
        ...
        // Five Components Section Heading
        { name: 'sectionComponentsHeading', label: 'Five Components: Section Heading', type: 'text', aiRewrite: true },
        { name: 'sectionComponentsSubheading', label: 'Five Components: Section Subheading', type: 'textarea', rows: 2 },
        ...
        { name: 'compare1Without', label: 'Row 1: Bad (left)', type: 'text' },
        { name: 'compare1With', label: 'Row 1: Good (right)', type: 'text' },
        { name: 'compare2Without', label: 'Row 2: Bad (left)', type: 'text' },
        { name: 'compare2With', label: 'Row 2: Good (right)', type: 'text' },
        { name: 'compare3Without', label: 'Row 3: Bad (left)', type: 'text' },
        { name: 'compare3With', label: 'Row 3: Good (right)', type: 'text' },
        { name: 'compare4Without', label: 'Row 4: Bad (left)', type: 'text' },
        { name: 'compare4With', label: 'Row 4: Good (right)', type: 'text' },
        { name: 'compare5Without', label: 'Row 5: Bad (left)', type: 'text' },
        { name: 'compare5With', label: 'Row 5: Good (right)', type: 'text' },
        { name: 'compare6Without', label: 'Row 6: Bad (left)', type: 'text' },
        { name: 'compare6With', label: 'Row 6: Good (right)', type: 'text' },
      ...
      previewUrl="/how-do-i-design-a-good-sales-comp-plan"
    />
  )
}
