...
export default function SeoFslVsSalesConsultantPage() {
  return (
    <SectionEditor
      section="seoFslVsSalesConsultant"
      title="SEO: Fractional Sales Leader vs. Sales Consultant"
      description="Edit content for /fractional-sales-leader-vs-sales-consultant"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/fractional-sales-leader-vs-sales-consultant"
    />
  )
}
