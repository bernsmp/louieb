...
export default function SeoFounderSalesNotScalingPage() {
  return (
    <SectionEditor
      section="seoFounderSalesNotScaling"
      title="SEO: Founder-Led Sales Not Scaling"
      description="Edit content for /founder-led-sales-not-scaling"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'Founder-Led Sales' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: "Isn't Scaling." },
        { name: 'heroLine3', label: 'Hero: Line 3', type: 'text', placeholder: "Here's Why — and What to Do." },
