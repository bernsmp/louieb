...
export default function SeoFslWorthItPage() {
  return (
    <SectionEditor
      section="seoFslWorthIt"
      title="SEO: Is Fractional Sales Leadership Worth It?"
      description="Edit content for /is-fractional-sales-leadership-worth-it"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/is-fractional-sales-leadership-worth-it"
    />
  )
}
