...
export default function SeoWarningSaleProcessPage() {
  return (
    <SectionEditor
      section="seoWarningSalesProcessBreaking"
      title="SEO: 5 Warning Signs Your Sales Process Is Breaking"
      description="Edit content for /5-warning-signs-sales-process-breaking"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/5-warning-signs-sales-process-breaking"
    />
  )
}
