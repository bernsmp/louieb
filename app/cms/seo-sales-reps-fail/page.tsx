...
export default function SeoSalesRepsFailPage() {
  return (
    <SectionEditor
      section="seoSalesRepsFail"
      title="SEO: Why Sales Reps Fail in Startups"
      description="Edit content for /why-sales-reps-fail-in-startups"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'Why Sales Reps Fail' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'in Startups' },
