...
export default function SeoSalesAccountabilityDocumentPage() {
  return (
    <SectionEditor
      section="seoSalesAccountabilityDocument"
      title="SEO: Why Every Sales Team Needs an Accountability Document"
      description="Edit content for /sales-accountability-document"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'Why Every Sales Team Needs' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'an Accountability Document' },
