...
export default function SeoSalesPlaybookPage() {
  return (
    <SectionEditor
      section="seoWhatIsASalesPlaybook"
      title="SEO: What Is a Sales Playbook"
      description="Edit content for /what-is-a-sales-playbook"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/what-is-a-sales-playbook"
    />
  )
}
