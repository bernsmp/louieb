...
export default function SeoGetOutFounderLedSalesPage() {
  return (
    <SectionEditor
      section="seoGetOutFounderLedSales"
      title="SEO: How to Get Out of Founder-Led Sales"
      description="Edit content for /how-to-get-out-of-founder-led-sales"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/how-to-get-out-of-founder-led-sales"
    />
  )
}
