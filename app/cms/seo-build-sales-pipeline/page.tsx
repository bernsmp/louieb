...
export default function SeoBuildSalesPipelinePage() {
  return (
    <SectionEditor
      ...
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Build a Sales Pipeline' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'That Actually Fills Itself' },
