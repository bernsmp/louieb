...
export default function SeoWhenToHirePage() {
  return (
    <SectionEditor
      section="seoWhenToHire"
      title="SEO: When to Hire a Fractional CRO"
      description="Edit content for /when-to-hire-a-fractional-cro"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'When to Hire a Fractional CRO:' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: "7 Signs You're Ready" },
