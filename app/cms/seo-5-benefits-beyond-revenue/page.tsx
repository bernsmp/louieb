...
export default function SeoFiveBenefitsBeyondRevenuePage() {
  return (
    <SectionEditor
      section="seoFiveBenefitsFslBeyondRevenue"
      title="SEO: 5 Benefits of a Fractional Sales Leader (Beyond Revenue)"
      description="Edit content for /5-benefits-fractional-sales-leader-beyond-revenue"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        // Hero
        ...
        { name: 'heroAccent', label: 'Hero: Accent Line (teal text)', type: 'text', aiRewrite: true },
        ...
        // 5 Benefits Section Heading
        { name: 'sectionBenefitsHeading', label: '5 Benefits: Section Heading', type: 'text', aiRewrite: true },
        { name: 'sectionBenefitsSubheading', label: '5 Benefits: Section Subheading', type: 'textarea', rows: 2 },

        // Benefit 1
        { name: 'benefit1Title', label: 'Benefit 1: Title', type: 'text', aiRewrite: true },
        { name: 'benefit1Detail', label: 'Benefit 1: Detail Paragraph', type: 'textarea', aiRewrite: true, rows: 6 },
        { name: 'benefit1Outcome', label: 'Benefit 1: "What You Get" Outcome', type: 'textarea', aiRewrite: true, rows: 2 },

        // Benefit 2
        { name: 'benefit2Title', label: 'Benefit 2: Title', type: 'text', aiRewrite: true },
        { name: 'benefit2Detail', label: 'Benefit 2: Detail Paragraph', type: 'textarea', aiRewrite: true, rows: 6 },
        { name: 'benefit2Outcome', label: 'Benefit 2: "What You Get" Outcome', type: 'textarea', aiRewrite: true, rows: 2 },

        // Benefit 3
        { name: 'benefit3Title', label: 'Benefit 3: Title', type: 'text', aiRewrite: true },
        { name: 'benefit3Detail', label: 'Benefit 3: Detail Paragraph', type: 'textarea', aiRewrite: true, rows: 6 },
        { name: 'benefit3Outcome', label: 'Benefit 3: "What You Get" Outcome', type: 'textarea', aiRewrite: true, rows: 2 },

        // Benefit 4
        { name: 'benefit4Title', label: 'Benefit 4: Title', type: 'text', aiRewrite: true },
        { name: 'benefit4Detail', label: 'Benefit 4: Detail Paragraph', type: 'textarea', aiRewrite: true, rows: 6 },
        { name: 'benefit4Outcome', label: 'Benefit 4: "What You Get" Outcome', type: 'textarea', aiRewrite: true, rows: 2 },

        // Benefit 5
        { name: 'benefit5Title', label: 'Benefit 5: Title', type: 'text', aiRewrite: true },
        { name: 'benefit5Detail', label: 'Benefit 5: Detail Paragraph', type: 'textarea', aiRewrite: true, rows: 6 },
        { name: 'benefit5Outcome', label: 'Benefit 5: "What You Get" Outcome', type: 'textarea', aiRewrite: true, rows: 2 },
      ...
      previewUrl="/5-benefits-fractional-sales-leader-beyond-revenue"
    />
  )
}
