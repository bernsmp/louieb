...
export default function SeoVpSalesVsFullTimePage() {
  return (
    <SectionEditor
      section="seoVpSalesVsFullTime"
      title="SEO: Fractional VP Sales vs Full-Time VP"
      description="Edit content for /fractional-vp-sales-vs-full-time-vp"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/fractional-vp-sales-vs-full-time-vp"
    />
  )
}
