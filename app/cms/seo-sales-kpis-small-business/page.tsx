...
export default function SeoSalesKPIsPage() {
  return (
    <SectionEditor
      section="seoSalesKPIsSmallBusiness"
      title="SEO: The 7 Sales KPIs Every $1M–$10M Business Should Track"
      description="Edit content for /sales-kpis-for-small-business"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'The 7 Sales KPIs Every' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: '$1M–$10M Business Should Track' },
