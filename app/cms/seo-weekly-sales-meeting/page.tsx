...
export default function SeoWeeklySalesMeetingPage() {
  return (
    <SectionEditor
      section="seoWeeklySalesMeeting"
      title="SEO: How to Run a Weekly Sales Meeting"
      description="Edit content for /how-to-run-weekly-sales-meeting"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/how-to-run-weekly-sales-meeting"
    />
  )
}
