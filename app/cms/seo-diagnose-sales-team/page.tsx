...
export default function SeoDiagnoseSalesTeamPage() {
  return (
    <SectionEditor
      section="seoDiagnoseSalesTeamProblems"
      title="SEO: How to Diagnose Why Your Sales Team Isn't Growing Revenue"
      description="Edit content for /diagnose-sales-team-problems"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Diagnose Why Your Sales Team' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: "Isn't Growing Revenue" },
