...
export default function SeoFslVsSalesCoachPage() {
  return (
    <SectionEditor
      section="seoFslVsSalesCoach"
      title="SEO: Fractional Sales Leader vs. Sales Coach"
      description="Edit content for /fractional-sales-leader-vs-sales-coach"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/fractional-sales-leader-vs-sales-coach"
    />
  )
}
