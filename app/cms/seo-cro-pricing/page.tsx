...
export default function SeoCROPricingPage() {
  return (
    <SectionEditor
      section="seoCROPricing"
      title="SEO: Fractional CRO Pricing"
      description="Edit content for /fractional-cro-pricing"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'Fractional CRO Pricing:' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Real Numbers. No Surprises.' },
