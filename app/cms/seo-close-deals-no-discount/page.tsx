...
export default function SeoCloseDealsNoDiscountPage() {
  return (
    <SectionEditor
      section="seoHowToCloseDealsNoDiscount"
      title="SEO: How to Close More Deals Without Discounting"
      description="Edit content for /how-to-close-deals-without-discounting"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        { name: 'heroLine1', label: 'Hero: Headline Line 1', type: 'text', aiRewrite: true, placeholder: 'How to Close More Deals' },
        { name: 'heroAccent', label: 'Hero: Accent Line (blue text)', type: 'text', aiRewrite: true, placeholder: 'Without Discounting Your Price' },
