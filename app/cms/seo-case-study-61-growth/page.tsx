...
export default function SeoCaseStudy61GrowthPage() {
  return (
    <SectionEditor
      section="seoCaseStudy61SalesGrowth"
      title="SEO: Case Study — 61% Sales Growth in One Year"
      description="Edit content for /case-study-61-percent-sales-growth"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/case-study-61-percent-sales-growth"
    />
  )
}
