...
export default function Seo250kVpSalesMistakePage() {
  return (
    <SectionEditor
      section="seo250kMistakeVpSalesHire"
      title="SEO: The $250,000 VP of Sales Mistake"
      description="Edit content for /250k-mistake-vp-sales-hire-too-early"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
      ...
      previewUrl="/250k-mistake-vp-sales-hire-too-early"
    />
  )
}
