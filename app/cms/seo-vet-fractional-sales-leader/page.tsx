...
export default function SeoVetFractionalSalesLeaderPage() {
  return (
    <SectionEditor
      section="seoVetFractionalSalesLeader"
      title="SEO: How Do I Vet a Fractional Sales Leader?"
      description="Edit content for /how-do-i-vet-a-fractional-sales-leader"
      backHref="/cms"
      backLabel="Dashboard"
      fields={[
        // Hero
        ...
        // 5 Things to Look For — Section Heading
        ...
        { name: 'compare1Without', label: 'Row 1: Wrong Way (left)', type: 'text' },
        { name: 'compare1With', label: 'Row 1: Right Way (right)', type: 'text' },
        { name: 'compare2Without', label: 'Row 2: Wrong Way (left)', type: 'text' },
        { name: 'compare2With', label: 'Row 2: Right Way (right)', type: 'text' },
        { name: 'compare3Without', label: 'Row 3: Wrong Way (left)', type: 'text' },
        { name: 'compare3With', label: 'Row 3: Right Way (right)', type: 'text' },
        { name: 'compare4Without', label: 'Row 4: Wrong Way (left)', type: 'text' },
        { name: 'compare4With', label: 'Row 4: Right Way (right)', type: 'text' },
        { name: 'compare5Without', label: 'Row 5: Wrong Way (left)', type: 'text' },
        { name: 'compare5With', label: 'Row 5: Right Way (right)', type: 'text' },
        { name: 'compare6Without', label: 'Row 6: Wrong Way (left)', type: 'text' },
        { name: 'compare6With', label: 'Row 6: Right Way (right)', type: 'text' },
      ...
      previewUrl="/how-do-i-vet-a-fractional-sales-leader"
    />
  )
}
