...
Have you witnessed this?`,
  ...
  seo: {
    siteTitle: 'Fractional Sales Leader | Louie Bernstein',
    siteDescription: 'INC 500 Founder helping $1M–$10M ARR founders since 2017 build repeatable sales systems. Stop being the bottleneck — let\'s talk.',
...
// ============================================================================
// STILL IN THE GAME PAGE
// ============================================================================

export interface StillInTheGameContent {
  heroHeadline: string
  ...
  hookHeadline: string
  hookBody: string
  hookCalloutHeadline: string
  hookCalloutBody: string
  aboutBio1: string
  aboutBio2: string
  aboutBio3: string
  closingQuote: string
...
const defaultStillInTheGame: StillInTheGameContent = {
  heroHeadline: 'Still In The Game',
  heroSubheadline: 'The Decisions That Actually Keep You There',
  heroTagline: 'Five decades. Five decisions. One framework that builds the resilience to get you to the next stage — and keep you there. Each chapter closes with prompts built to run in Claude.',
  videoId: '',
  price: '47',
  buyButtonUrl: '',
  buyButtonText: 'Buy Now — $47',
  hookHeadline: "Most business advice is written by people who haven't finished the race yet.",
  hookBody: "They're successful. They're smart. But they're still in the middle of it. They haven't hit the decisions that only come after decade two or three — the ones nobody talks about honestly because they're still too close to them.",
  hookCalloutHeadline: 'Louie Bernstein is 74. He built a bootstrapped company that ran for 22 years and made the INC 500. He survived 9/11, a burnout, a depression diagnosis, and about forty other things that should have ended everything.',
  hookCalloutBody: 'He finished the race. Then he started again. This framework is what he learned.',
  aboutBio1: 'Louie Bernstein launched his first company in 1986 with a broken vertebra, a two-year-old at home, a second child weeks away, and life savings already spent. MindIQ ran for 22 years, made the INC 500, and survived everything from 9/11 to a full founder burnout.',
  aboutBio2: 'After stepping away in 2015, he took a Chief Sales Officer role at a Georgia Tech startup and grew sales 52% per year for three years. When that chapter ended, he built what he would have hired during his own hardest years — a Fractional Sales Leadership practice for bootstrapped founders and entrepreneurs.',
  aboutBio3: 'At 74, he is still going. Not because he has to be. Because he knows exactly what he is doing now.',
  closingQuote: 'Nobody arrives at the end of their life wishing they had taken fewer chances.',
}

export const getStillInTheGameContent = cache(async (): Promise<StillInTheGameContent> => {
  if (!USE_SUPABASE_CMS || !isSupabaseConfigured || !supabaseAdmin) {
    return defaultStillInTheGame
  }
  ...
  try {
    ...
    const overrides = data.content as Partial<StillInTheGameContent>
    return { ...defaultStillInTheGame, ...overrides }
  } catch {
    return defaultStillInTheGame
  }
})
