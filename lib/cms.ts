...
const defaultStillInTheGame: StillInTheGameContent = {
  ...
  heroTagline: 'Five decades. Five decisions. One framework you can use today. Each chapter closes with prompts built to run in Claude.',
  videoId: '',
  price: '47',
  buyButtonUrl: '',
  ...
  hookCalloutHeadline: 'Louie Bernstein is 74. He built a company from scratch that ran for 22 years and made the INC 500. He survived 9/11, a burnout, a depression diagnosis, and about forty other things that should have ended everything.',
  hookCalloutBody: 'He finished the race. Then he started again. This is what he learned.',
  ...
  aboutBio2: 'After stepping away in 2015, he took a Chief Sales Officer role at a Georgia Tech startup and grew sales 52% per year for three years. When that chapter ended, he built what he would have hired during his own hardest years — a Fractional Sales Leadership practice for bootstrapped founders.',
