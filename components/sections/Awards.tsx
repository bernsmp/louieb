      ...
      <div className="container mx-auto max-w-5xl px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-xl text-neutral-600">
            Award-winning sales consulting and leadership
          </p>
        </div>
        ...
        <div className="mt-20 flex justify-center">
          <div className="relative rounded-3xl border-2 border-neutral-900 bg-white p-8 shadow-2xl lg:p-12">
            <img
              src="https://d1yei2z3i6k35z.cloudfront.net/1671832/64e3c2e5505e3_fourawards.png"
              alt="Four Sales Consulting Awards"
        ...
        <div className="mt-16 text-center">
          <p className="text-xl font-semibold text-neutral-900 md:text-2xl">
            Louie Bernstein has received{" "}
            <span className="text-neutral-600">four prestigious awards</span> for excellence in sales consulting and leadership.
          </p>
        </div>
      </div>
    </section>
