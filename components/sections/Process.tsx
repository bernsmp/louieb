  ...
  const steps = [
    {
      ...
      description:
        "We start with a deep dive into your current sales operations. I'll assess your team, processes, and challenges to create a customized plan.",
    },
    {
      number: "02",
      title: "Strategic Planning",
      description:
        "Together, we'll develop a roadmap for improvement. Clear objectives, measurable KPIs, and a timeline that works for your business.",
    },
    {
      number: "03",
      title: "Implementation",
      description:
        "I'll work directly with your team to implement new systems and processes. Hands-on training ensures everyone knows exactly what to do.",
    },
    {
      number: "04",
      title: "Optimization & Growth",
      description:
        "Continuous improvement is key. We'll monitor results, make adjustments, and scale what works to drive consistent growth.",
    },
  ];
      ...
      <div className="container mx-auto max-w-6xl px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-xl text-neutral-600">
            A proven process that delivers measurable results
          </p>
        </div>
