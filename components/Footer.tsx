          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Louie Bernstein on LinkedIn"
                className="block h-10 w-10 overflow-hidden rounded-full border-2 border-primary/20 shadow-sm transition-all hover:border-primary hover:shadow-md"
              >
                <Image
